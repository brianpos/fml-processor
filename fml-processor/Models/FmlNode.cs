...
/// <summary>
/// Base class for all FML syntax tree nodes.
/// Provides common infrastructure for position tracking and hidden token preservation.
/// </summary>
/// <remarks>
/// All FML model classes inherit from this base to provide:
...
/// <summary>
/// Extension methods for working with FML syntax tree nodes
/// </summary>
public static class FmlNodeExtensions
{
    /// <summary>
    /// Gets all comment tokens from both leading and trailing positions
    /// </summary>
    public static IEnumerable<HiddenToken> GetAllComments(this FmlNode node)
    {
    ...
    /// </summary>
    public static bool HasComments(this FmlNode node)
    {
    ...
    /// </summary>
    public static void ClearHiddenTokens(this FmlNode node)
    {
    ...
    /// </summary>
    public static void CopyHiddenTokensFrom(this FmlNode target, FmlNode source)
    {
    ...
    /// </summary>
    public static bool HasPosition(this FmlNode node)
    {
    ...
    /// </summary>
    public static string GetLeadingText(this FmlNode node)
    {
    ...
    /// </summary>
    public static string GetTrailingText(this FmlNode node)
    {
