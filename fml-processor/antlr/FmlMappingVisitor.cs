...
public interface IFmlMappingVisitor<Result> : IParseTreeVisitor<Result> {
	...
	/// <param name="context">The parse tree.</param>
	/// <return>The visitor result.</return>
	Result VisitMapSimpleBatchIdentity([NotNull] FmlMappingParser.MapSimpleBatchIdentityContext context);
	/// <summary>
	...
	/// <param name="context">The parse tree.</param>
	/// <return>The visitor result.</return>
	Result VisitIdentityFieldList([NotNull] FmlMappingParser.IdentityFieldListContext context);
	/// <summary>
