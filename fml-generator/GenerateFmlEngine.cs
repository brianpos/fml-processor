...
namespace fml_tester
{
    public class GenerateFmlEngine
    {
        ...
        public static void WriteMapsAndReviewNotes(string sourceVersion, string targetVersion, List<FmlStructureMap> maps)
        {
        ...
        public static void TraceIniContentForMaps(IEnumerable<FmlStructureMap> maps, List<string> exitingMaps)
        {
